...
router.get(
  "/user-profile",
  verifyUserToken,
  controller.userController.showUserProfile
);
...
router.put(
  ...
  verifyUserToken,
  controller.userController.editUserProfile
);
router.put(
...
router.post(
  ...
  validate(userFeedbackValidation),
  controller.userController.submitFeedBack
);
...
router.post(
  "/search-lyricfind",
  controller.lyricsController.searchLyricsFindSongs
);
...
router.put(
  "/edit-user-comment",
  verifyUserToken,
  controller.userController.editUserComment
);
router.delete(
  "/delete-user-comment",
  verifyUserToken,
  controller.userController.deleteUserComment
);
