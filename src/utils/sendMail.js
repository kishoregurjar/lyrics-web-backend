...
const { forgetPassTempFun } = require("../templates/forgetPassTemp");
...
module.exports.genericMail = async (email, userName, authLink, type) => {
  ...
  if (type === "welcome") {
    ...
    template = forgetPassTempFun(userName, authLink);
    subject = "Reset Password";
    body_text = `Please Reset Your Password with below given Link`;
  }
